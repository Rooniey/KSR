...
namespace AttributeExtractor.Processing
{
    public class StopWordsFilterProcessor : ITokenProcessor
    {
        ...
        {
                return tokens.Where(t => !_stopList.Contains(t)).ToList();
        }
    }
}
